...
function generate(collections, additionnalBenefitAttributes) {
  ...
  const benefits = [
    ...
    return Object.assign(
      {},
      benefit,
      additionnalBenefitAttributes[benefit.slug]
    )
  })
...
module.exports = {
  fn: generate,
  generate: (jam) => generate(jam.collections, additionnalBenefitAttributes),
}

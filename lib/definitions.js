...
definitions.simulation = {
    required: ['al.éligibilité', 'rsa.conditionÂge', 'demandeur.situationFamiliale', 'demandeur.mineur', 'demandeur.salaire3DerniersMois', 'demandeur.situationPro', 'demandeur.revenus'],

...
module.exports = function(app) {
    ...
    app.route('/back/partials/*').get(index.backPartials);
    app.route('/back').get(index.back);
    app.route('/back/*').get(index.back);

    app.route('/partials/*').get(index.frontPartials);
    app.route('/*').get(index.front);
};

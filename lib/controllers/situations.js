...
exports.cerfa = function(req, res) {
    ...
    situation.individus.forEach(function(individu) {
        ...
        if (individu.dateArriveeFoyer) {
            individu.dateArriveeFoyer = moment(individu.dateArriveeFoyer).format('DD/MM/YYYY');
        }
        if (individu.dateSituationFamiliale) {
            individu.dateSituationFamiliale = moment(individu.dateSituationFamiliale).format('DD/MM/YYYY');
        }
    });

    if (situation.logement.dateArrivee) {
        situation.logement.dateArrivee = moment(situation.logement.dateArrivee).format('DD/MM/YYYY');
    }

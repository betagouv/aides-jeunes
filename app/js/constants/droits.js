...
angular.module('ddsCommon').constant('droitsDescription', {
    ...
    'aspa': {
        ...
        'conditions': [
            ...
            'Avoir demandé l’attribution de toutes vos retraites personnelles et de réversion à tous les régimes.',
            'Votre conjoint doit avoir demandé l’attribution de toutes ses retraites personnelles et de reversion à tous les régimes.'
        ],

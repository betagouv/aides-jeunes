...
FollowupSchema.virtual("wasUsefulPath").get(function (this: any) {
  return `/api/followups/surveys/${this.accessToken}/surveyType/${SurveyType.trackClicSimulationUsefulnessEmail}?wasuseful=1`
})

FollowupSchema.virtual("wasNotUsefulPath").get(function (this: any) {
  return `/api/followups/surveys/${this.accessToken}/surveyType/${SurveyType.trackClicSimulationUsefulnessEmail}?wasuseful=0`
})

    ...
    <div class="fr-grid-row fr-grid-row--gutters">
      ...
      <div class="fr-col-12 fr-col-lg-9 fr-mt-4w">
        ...
        <p class="fr-text--md">
          ...
          enrichissez le simulateur en ajoutant vos aides à destination des
          jeunes de 15 à 30 ans.
        </p>
        <p class="fr-text--md fr-mb-3w">
          Remplissez ce formulaire pour proposer une nouvelle aide. Les champs
          marqués d'une étoile <span class="fr-text--error">(*)</span> sont
          requis. Votre proposition sera relue par notre équipe avant d'être
          publiée sur le simulateur. Merci pour votre contribution !
        </p>
        <div class="fr-callout fr-callout--info">
          <h6 class="fr-callout__title">Une question ?</h6>
          <p class="fr-callout__text">
            Si vous rencontrez des difficultés pour remplir ce formulaire ou si
            vous avez des questions, n'hésitez pas à contacter notre équipe par
            email :
            <a
              v-mail="mailContent"
        ...
        <div v-if="sent" class="fr-alert fr-alert--success fr-mb-4w">
          <p>
            Merci, votre proposition a bien été envoyée ! Elle sera relue par
            notre équipe avant d’être publiée sur le simulateur.
          </p>
          <p class="fr-mt-2w">
        ...
        <form v-if="!sent" class="fr-my-4w" novalidate @submit.prevent="submit">
              ...
              >
                ...
                >
                  <option value="" disabled
                    >Sélectionnez une périodicité</option
                  >
                  <option
            ...
            <div class="fr-fieldset__content">
              <div class="fr-input-group">
                ...
                <span class="fr-hint-text"
                  ...
                  Valeur numérique » pour afficher un montant (exemple : 200 €,
                  35 € par mois, 12 séances gratuites, 100 repas offerts, 25% de
                  réduction) ; « Éligibilité Oui/Non » pour indiquer uniquement
                  si la personne a droit à l'aide ou non ; « Autre » uniquement
                  pour des cas spécifiques (texte personnalisé, message
                  particulier, format non standard)</span
                >
              ...
              <div v-if="resultType !== 'bool'" class="fr-input-group">
                ...
                <span class="fr-hint-text"
                  ...
                  vous avez indiqué "200" en valeur numérique et "€" en unité,
                  cela affichera "200 € maximum."</span
                >
                <input
                  id="legend"
                  v-model="legend"
          ...
          <fieldset class="fr-fieldset fr-mb-4w">
            ...
            <p class="fr-text--sm fr-mb-3w">
              <strong>Au moins un lien doit être renseigné</strong>
              (information, téléservice, formulaire ou instructions). Ces liens
              permettront aux usagers de trouver plus d'informations ou de faire
              leur demande.
            </p>
            <div class="fr-fieldset__content">
              <div class="fr-grid-row fr-grid-row--gutters">

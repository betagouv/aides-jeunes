...
var individu = Object.assign({
    ...
    scolarite: { type: String, enum: ['inconnue', 'college', 'lycee', 'enseignement_superieur'] },
    statuts_etablissement_scolaire: { type: String, enum: ['inconnu', 'public', 'prive_sous_contrat', 'prive_hors_contrat'] },
...
var parents = {
    _situation: { type: String, enum: ['en_couple', 'separes', 'decedes', 'sans_autorite', 'veuve'] },
    _en_france: Boolean,
};

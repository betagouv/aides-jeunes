  ...
  <article class="text container">
    ...
    <p
      ...
      <a
        ...
        >statistiques d'usage de Mes Aides</a
      >
      sont publiques.</p
    >
    <p
    ...
    <iframe
      id="iframe"
      style="border: none; display: block; margin: 10px auto; min-height: 700px"

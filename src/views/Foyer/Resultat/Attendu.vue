  ...
  <form @submit.prevent="submit">
    <div v-if="!result">
      ...
      >
        ...
        <button
          class="form__group button small warning"
    ...
    <div v-if="result">
      <p>
        Les informations saisies ont bien été enregistrées. Elles sont
        accessibles à
        <a target="_blank" rel="noopener" v-bind:href="result.data.html_url">
          la page suivante </a
        >.
      </p>
      ...
      <p
        ...
        <router-link to="/foyer/resultat"> la page de résultats </router-link
        >.</p
      >
    </div>
  </form>

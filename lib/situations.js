        ...
        if (individu) {
          switch (answer.fieldName) {
            ...
            case "_interetAidesSanitaireSocial": {
              ...
              const formationAnswer = allAnswers.find((otherAnswer) => {
                return (
                  otherAnswer.fieldName === "_formationSanitaireSocial" &&
                  otherAnswer.id === "demandeur" &&
                  otherAnswer.entityName === "individu"
                )
              })
              individu["_interetAidesSanitaireSocial"] = Boolean(
                formationAnswer?.value
              )
              break
            }
            case "statut_marital": {

...
export default {
  ...
  _agence_travail_temporaire: new BooleanProperty({
    ...
    moreInfo:
      "L’intérim ou travail temporaire est un contrat de travail passé avec une agence d’intérim, qui met le salarié à disposition d’une entreprise pour une durée limitée, souvent pour remplacer un absent ou faire face à un besoin ponctuel. Si le contrat a été signé avec une agence, il s’agit d’un emploi intérimaire.",
  }),
}

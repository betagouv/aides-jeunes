<template>
  <div>
    <p v-if="isProprietaireAvecPretEnCours || isHebergeParticipeFrais">
      ...
      <strong v-if="isProprietaireAvecPretEnCours">toujours en train de rembourser le crédit pour votre logement
        principal.</strong>
    ...
    <div>
      ...
      >caf.fr</a>, la question suivante est posée :

      <blockquote>
        <i>Vous (ou votre conjoint·e) êtes propriétaire de votre logement
      ...
      <ul>
        <li>
          « Non » si vous êtes bien
          <strong v-if="isProprietaireAvecPretEnCours">en train de rembourser le crédit pour votre logement
            principal.</strong>
          <strong v-else-if="isHebergeParticipeFrais">hébergé·e en participant aux frais du logement.</strong>
        </li>
        <li>
          « Oui » uniquement si
          <span v-if="isProprietaireAvecPretEnCours">vous n’avez
            <strong>pas de prêt pour votre habitation principale.</strong></span>
          <span v-else-if="isHebergeParticipeFrais">vous
            <strong>ne participez pas aux frais du logement.</strong></span>
        </li>
      </ul>
    </div>

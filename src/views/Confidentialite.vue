  ...
  <article class="text container aj-text-container">
    ...
    <div>
      ...
      <ul>
        ...
        <li
          ...
          demander selon votre situation personnelle ;</li
        >
        <li
        ...
        <li
          ...
          vous avez une difficulté à demander ou avoir accès à une aide.</li
        >
      </ul>
    </div>
    ...
    <div>
      <p
        ...
        fonctionnement du simulateur :</p
      >
      <ul>
        <li
    ...
    <div>
      <p
        ...
        manière spécifique, vous pourrez :</p
      >
      <ul>
    ...
    <p
      ...
      <a
        ...
        >ici</a
      >, un modèle de courrier élaboré par la CNIL.</p
    >
    ...
    <p
      ...
      strictes de confidentialité, d’usage et de protection des données.</p
    >
    ...
    <p
      >Des mesures techniques et organisationnelles de sécurité ont été adoptées
    ...
    <p
      ...
      (ordinateur, mobile ou tablette).</p
    >

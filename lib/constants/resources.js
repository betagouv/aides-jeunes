"use strict"
const Individu = require("../../src/lib/Individu")
...
let ressourceTypes = [
  ...
  },
  {
    ...
    category: "allocations",
    prefix: "des",
    isRelevant: (answers, individuId) => {
      return (
        individuId !== "demandeur" ||
        Boolean(answers.enfants && answers.enfants.length)
      )
    },
  },
  {
  ...
  },
  {
    ...
    isRelevant: (answers, individuId) => {
      return (
        ...
        Boolean(
          answers.enfants &&
            answers.enfants.filter((e) =>
              getAnswer(answers.all, "individu", "garde_aternee", `enfant_${e}`)
            ).length
        )
      )
    },
  ...
  },
  {
    ...
    isRelevant: (answers, individuId) => {
      return (
        55 <=
        Individu.age(
          getAnswer(answers.all, "individu", "date_naissance", individuId),
  ...
  },
  {
    ...
    prefix: "l’",
    isRelevant: (answers, individuId) => {
      return getAnswer(answers.all, "individu", "handicap", individuId)
    },
  },
  {
    id: "ass",
    ...
    isRelevant: (answers, individuId) => {
      return (
        getAnswer(answers.all, "individu", "activite", individuId) !==
        "etudiant"
      )
    },
  },
  ...
  },
  {
    ...
    isRelevant: (answers, individuId) => {
      return (
        ...
        Boolean(
          answers.enfants &&
            answers.enfants.filter((enfant) =>
              getAnswer(answers.all, "individu", "handicap", `enfant_${enfant}`)
            ).length
        )
      )
    },
  },
  {
    ...
    isRelevant: (answers, individuId) => {
      return (
        getAnswer(answers.all, "individu", "handicap", individuId) ||
        Boolean(
          answers.enfants &&
            answers.enfants.filter((enfant) =>
              getAnswer(answers.all, "individu", "handicap", `enfant_${enfant}`)
  ...
  },
  {
    ...
    isRelevant: (answers) => answers.enfants && answers.enfants.length,
  },
  {

...
module.exports = function(app, config) {
    ...
    if ('production' === env) {
        ...
        app.use('/secours-populaire', express.static(path.join(config.root, 'dist')));
        app.use('/back', express.static(path.join(config.root, 'dist')));
        app.use('/acceptance-tests', express.static(path.join(config.root, 'dist')));

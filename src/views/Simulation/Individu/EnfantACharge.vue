<template>
  <form @submit.prevent='onSubmit'>
    <YesNoQuestion v-model="value">
      <h1>{{ role === 'demandeur' ? `Figurez vous sur la dernière déclaration d'impôts de vos parents ?` : `Figure-t-il/elle sur votre dernière déclaration d'impôts sur le revenu&nbsp;?`}}</h1>
    </YesNoQuestion>
